...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Brand Primary - Fresh Teal (Clean, Fresh, Professional)
        brand: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Accent - Warm Amber (Energy, Warmth, Action)
        accent: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      boxShadow: {
        ...
        'strong': '0 8px 24px -4px rgba(0, 0, 0, 0.12), 0 16px 40px -8px rgba(0, 0, 0, 0.16)',
